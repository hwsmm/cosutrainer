...
{
    {
        ...
        window->align(Fl_Align(FL_ALIGN_CLIP|FL_ALIGN_INSIDE));
        {
            ...
            {
                scale_ar = new Fl_Check_Button(210, 250, 170, 25, "Scale AR");
                scale_ar->down_box(FL_DOWN_BOX);
                scale_ar->value(1);
            } // Fl_Check_Button* scale_ar
            {
                scale_od = new Fl_Check_Button(210, 275, 170, 25, "Scale OD");
                scale_od->down_box(FL_DOWN_BOX);
                scale_od->value(1);
            } // Fl_Check_Button* scale_od
            {
                pitch = new Fl_Check_Button(210, 300, 170, 25, "Adjust Pitch");
                pitch->down_box(FL_DOWN_BOX);
            } // Fl_Check_Button* pitch
            {
                nospinner = new Fl_Check_Button(210, 325, 170, 25, "No Spinner");
                nospinner->down_box(FL_DOWN_BOX);
            } // Fl_Check_Button* nospinner
            {
                cv_mapset = new Fl_Check_Button(210, 350, 170, 25, "Convert Mapset");
