...
static void gotquitsig(int sig)
{
    run = 0;
}

static void gottimersig(int sig)
{
}
...
skip:
            ...
            *(long*)msgbuf = COSU_IPCPATH; // mtype
            ...
            else if ((size_t)writ + 1 > msgbufsize)
            {
                fprintf(stderr, "Your message queue buffer is too small for this map path, ignoring this path.\n"
